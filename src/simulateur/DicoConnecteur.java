 ...
 * <p>
 * Cette classe se comporte comme un dictionnaire : si on lui fourni un nom elle
 * donnera un "connecteur" qui permettra de rattacher deux composant.
 * Ce connecteur représente un signal logique.
 * Si un signal n'a pas encore de lien attribué, c'est le dico qui se charge de
 * la création.
 * C'est à dire que le comportement est exatement le même si le connecteur
 * existait déjà ou non. <br>
 * De plus, il existe une methode pour savoir si un lien existe déjà ou non.
 * </p>
 *
...
public class DicoConnecteur {
	 ...
	 * <br>
	 * A savoir que cela est rarement nécessaire puisque le dico peut se charger lui
	 * meme de la création.
	 * 
	 * @param c
	 *            La poignée du connecteur à stocker.
	 * @param s
	 *            le String du nom auquel on associe la poignée. (on peut associer
	 *            une poignée à différents noms).
	 */
	 ...
	 * 
	 * @param s
	 *            le nom sous lequel on a enregistré ce connecteur.
	 */
