...
import static util.Assets.asset;
...
public class EntreeSimulateur extends ToggleButton {
    ...
    public static final Image imageUndef = new Image(asset("interupteur_undef.png"), 48, 48, true, false);
    public static final Image imageOff = new Image(asset("interupteur_off.png"), 48, 48, true, false);
    public static final Image imageOn = new Image(asset("interupteur_on.png"), 48, 48, true, false);
