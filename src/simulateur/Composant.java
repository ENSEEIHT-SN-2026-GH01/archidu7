 ...
 * <p>
 * Ce composant à un nombre d'entrées et de sorties variable.
 * Il s'agit d'une classe abstraite devrant être sppécialisée en fonction du
 * calcul logique effectué.
 * <br>
 * Les entrées/sorties sont implémentées par des Connecteurs qui permettent de
 * comminiquer des états logique entre differents composants.
 * C'est la méthode abstraite calculer qui doit etre reimplémenté pour chaque
 * spécialisation de cette classe.
 * 
...
public abstract class Composant implements Structure {
	 ...
	 * C'est probablement une erreur de l'avoir mis public, j'aurais du le mettre en
	 * protected.
	 * 
	 * @param nb_entrees
	 *                     le nombre d'entrées.
	 ...
	 * 
	 * @param l
	 *            la poigné du connecteur à retirer.
