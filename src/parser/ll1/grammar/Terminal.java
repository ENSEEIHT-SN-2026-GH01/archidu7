...
public final class Terminal implements Symbol {
    ...
    public Terminal(Token type) {
        this(Objects.requireNonNull(type), false);
    }

    private Terminal(Token type, boolean epsilon) {
        this.type = type;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(type, epsilon);
    }

    @Override
    public String toString() {
        return epsilon ? "ε" : type.name();
    }
}
