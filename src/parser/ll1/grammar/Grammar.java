...
public final class Grammar {
    ...
    private static Grammar buildShdl() {
        ...
        final NonTerminal START = NonTerminal.Start,
        ...
        final Token ModuleKW = Token.ModuleKW,
                EndKW = Token.EndKW,
                OnKW = Token.OnKW,
                WhenKW = Token.WhenKW,
                SetKW = Token.SetKW,
        ...
        // Module ::= ModuleKW Identifiant LeftPar Param Separ_Param_Star RightPar
        // Instance_Plus EndKW ModuleKW
        ...
        // Signal_Subset_Opt ::= LeftSquareBrack NaturalInteger Range_Opt
        // RightSquareBrack | ε
        ...
        // SignalOrLiteralCompound ::= Signal_Or_Litteral_Value
        // Concat_Signal_Or_Litteral_Value_Star
        ...
        // Concat_Signal_Or_Litteral_Value_Star ::= ConcatOp Signal_Or_Litteral_Value
        ...
        // MemoryAssignment ::= MemAssignOp SumOfTermsCompound OnKW SumOfTerms Comma_Opt
        // Set_Or_Reset WhenKW SumOfTerms Enabled_Operand_Opt Semicolon_Opt
     ...
     * Format : une ligne par production, "Head ::= sym1 sym2 ..." avec ε pour
     * epsilon.
     */
    public String toBnf() {
