...
/**
 * Produit une representation textuelle indentee (box-drawing) d'un
 * {@link CstNode}.
 *
 * <p>
 * Format pour un {@link CstInternal} :
 * 
 * <pre>
 *   NT @start..end [NT -> sym1 sym2 ...]
 * </pre>
 * 
 * Si la production est epsilon ou children est vide, ajoute deux espaces puis
 * {@code (vide)}.
 *
 * <p>
 * Format pour un {@link CstLeaf} avec texte non-vide :
 * 
 * <pre>
