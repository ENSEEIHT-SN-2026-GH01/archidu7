...
public final class FsmHeader implements Node {
    public enum Kind {
        ASYNCHRONOUS, SYNCHRONOUS_ON_RESET, RESET_WHEN_SYNC
    }
    ...
    public Optional<SumOfTerms> getClock() {
        return Optional.ofNullable(clock);
    }

    public Optional<String> getResetStateName() {
        return Optional.ofNullable(resetStateName);
    }

    public Optional<SumOfTerms> getResetCondition() {
        return Optional.ofNullable(resetCondition);
    }
