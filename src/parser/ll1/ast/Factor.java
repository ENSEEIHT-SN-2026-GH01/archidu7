...
public final class Factor implements Node {
    public enum Kind {
        SIGNAL, NEG_SIGNAL, LITERAL_0, LITERAL_1, BITFIELD, PAREN
    }
    ...
    public static Factor signal(Position p, Signal s) {
        return new Factor(p, Kind.SIGNAL, s, null, null);
    }

    public static Factor negSignal(Position p, Signal s) {
        return new Factor(p, Kind.NEG_SIGNAL, s, null, null);
    }

    public static Factor lit0(Position p) {
        return new Factor(p, Kind.LITERAL_0, null, null, null);
    }

    public static Factor lit1(Position p) {
        return new Factor(p, Kind.LITERAL_1, null, null, null);
    }

    public static Factor bits(Position p, BitField b) {
        return new Factor(p, Kind.BITFIELD, null, b, null);
    }

    public static Factor paren(Position p, SumOfTerms s) {
        return new Factor(p, Kind.PAREN, null, null, s);
    }
