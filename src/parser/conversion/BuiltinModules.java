 ...
 *
 * <p>
 * Convention groupe : un appel {@code $Nom(...)} référence une primitive
 * implémentée en Java côté simulateur (cf.
 * {@code simulateur.FileSimulateur#SimulateurInterne}),
 * pas un module SHDL. La conversion fabrique ici un {@link Module} virtuel dont
 * le
 * {@code Nom} commence par '$' — c'est ce préfixe qui déclenche le dispatch
 * dans {@code FileSimulateur}.
 *
 * <p>
 * Le {@code Plan} et {@code Branchements} sont vides : le simulateur n'a
 * jamais besoin de descendre dedans, il instancie directement la primitive
 * Java.
 *
 * <p>
 * Chaque {@link #get(String)} retourne une <b>instance fraîche</b> et non un
...
final class BuiltinModules {
     ...
     * Bascule D.
     * <ul>
     * <li>Entrées (ordre imposé par {@code BasculeDSimulateur}) : en, clock,
     * signal, reset.</li>
     ...
     *
     * @param dollarName
     *                       nom complet avec le préfixe '$' (ex. "$BasculeD")
     */
