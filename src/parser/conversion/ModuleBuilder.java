...
public final class ModuleBuilder {
        ...
        public static Module build(CstNode moduleNode) {
                ...
                plan.add(buildInstance(ip.first(NonTerminal.Instance)
                ...
                while (!star.children().isEmpty()) {
                        ...
                        plan.add(buildInstance(star.first(NonTerminal.Instance)
                        ...
                        if (!(nextStarNode instanceof CstInternal nextStar)
                                        || nextStar.nt() != NonTerminal.Instance_Star) {
                                throw new ConversionException(nextStarNode.startOffset(),
                                                String.valueOf(nextStarNode.symbol()),
                                                ConversionException.Reason.MALFORMED_CST,
        ...
        private static void validateParams(CstInternal mod) {
                ...
                Names.extractScalarFromSignalNT(fpInt.first(NonTerminal.Signal)
                ...
                while (!sps.children().isEmpty()) {
                        ...
                        Names.extractScalarFromSignalNT(pInt.first(NonTerminal.Signal)
                        ...
                        if (!(nextSpsNode instanceof CstInternal nextSps)
                                        || nextSps.nt() != NonTerminal.Separ_Param_Star) {
                                throw new ConversionException(nextSpsNode.startOffset(),
                                                String.valueOf(nextSpsNode.symbol()),
                                                ConversionException.Reason.MALFORMED_CST,
        ...
        private static Erwan buildInstance(CstNode instanceNode, Set<String> lhsSeen) {
                ...
                CstNode subset = op.first(NonTerminal.Signal_Subset_Opt)
                ...
                if (assignment.has(NonTerminal.MemoryAssignment)) {
                        throw new ConversionException(assignment.startOffset(), "Assignment",
                                        ...
                                        "Affectation memoire (:=) non supportee en S1 (offset "
