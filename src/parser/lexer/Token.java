...
public enum Token {
  ...
  ConcatOp, PointPoint, Colon, OrOp, Star, NotOp, AssignOp, MemAssignOp, Comma, Semicolon, Dollar,

  Identifiant, BitField, NaturalInteger, whiteSpace, lineTerminator, Comment,
