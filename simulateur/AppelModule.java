 ...
 * <p> Un objet de cette classe fait partit des branchements existant dans un module.
 ...
 * ainsi que les signaux que l'on fournit depuis le module appelant comme entrée et sortie du sous module. <br>
 * Ces signaux sont désignés par des descripteurs, une liste pour les entrées du module et une autre pour les sorties. <br>
 * Attention à ne pas confondre avec les descripteur interne au module qui n'ont rien à voir,
 * et qui ne doivent pas être modifiés.</p>
 *
 * <p> Bonne Chance !!! </p>
 *
...
public class AppelModule implements Branchement {
	...
	/** C'est les descripteur d'entrées et de sortie qui indique les signaux à fournir au module.
	 */
