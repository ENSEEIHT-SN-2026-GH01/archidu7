...
public class MExperience2 {
	...
	public static void main(String[] Args) {
		...
		erwan.Module M = new erwan.Module("Bascule D",PlanCircuitSousModule,E,S,null);
		...
		Simulateur Si = new FileSimulateur(new erwan.Module("AppelBascule",EMM,DEM,DSM,AMM));
