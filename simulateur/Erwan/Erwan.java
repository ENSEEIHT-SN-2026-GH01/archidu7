 ...
 * mais cela ne se repercutera pas vraiment sur la syntax pour generer ces
 * signaux. <br>
...
public class Erwan implements Branchement {
	 ...
	 */
	public static Erwan APPELMODULE(String NomModule, List<String> NomEntrees, List<String> NomSorties) {
