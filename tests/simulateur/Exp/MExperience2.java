...
public class MExperience2 {
	...
	public static Erwan A(String Nom, int i, Erwan S) {
		return Erwan.AFFECTATION(Nom, i, S);
	}
	...
	public static Erwan L(String Nom, int i) {
		return Erwan.LITTERAL(Nom, i);
	}
	...
	public static void main(String[] Args) {
		...
		PlanCircuitSousModule.addAll(L(
				A("S", E(L(L("en"), L("clk"), L("sig"), N(L("reset"))))),
				A("R", O(L(
						L("reset"), E(L(
								L("en"), L("clk"), N(L("sig"))))))),
				A("Q", N(O(L(
		...
		E.add(new Descripteur("en"));
		E.add(new Descripteur("clk"));
		E.add(new Descripteur("sig"));
		E.add(new Descripteur("reset"));
		// E.add(new Descripteur("Fause_Entree"));
		List<Descripteur> S = new ArrayList<>();
		S.add(new Descripteur("Q"));
		S.add(new Descripteur("NQ"));
		simulateur.erwan.Module M = new simulateur.erwan.Module("Bascule D", PlanCircuitSousModule, E, S, null);
		...
		DEM.add(new Descripteur("Entree", 0, 0));
		DEM.add(new Descripteur("Entree", 1, 1));
		DEM.add(new Descripteur("Entree", 2, 2));
		DEM.add(new Descripteur("Entree", 3, 3));
		DSM.add(new Descripteur("Sortie", 0, 0));
		DSM.add(new Descripteur("Sortie", 1, 1));
		AMM.add(new AppelModule(M, DEM, DSM));
		List<Erwan> EMM = new ArrayList<>();
		DEM = new ArrayList<>();
		DSM = new ArrayList<>();
		DEM.add(new Descripteur("Entree", 0, 3));
		DSM.add(new Descripteur("Sortie", 0, 1));
		Simulateur Si = new FileSimulateur(new simulateur.erwan.Module("AppelBascule", EMM, DEM, DSM, AMM));
