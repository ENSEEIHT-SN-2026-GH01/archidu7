...
public class BExperience2 {
	...
	public static void main(String[] Args) {
		...
		Ap.add(new AppelModule(new simulateur.erwan.Module("$BaculeD", new ArrayList<>(), DE2, DS2, null), DE2, DS2));
		Ap.add(new AppelModule(new simulateur.erwan.Module("$BaculeD", new ArrayList<>(), DE1, DS1, null), DE1, DS1));
		...
		Simulateur Si = new FileSimulateur(new simulateur.erwan.Module("count2", PlanCircuitModule, DE, DS, Ap));
