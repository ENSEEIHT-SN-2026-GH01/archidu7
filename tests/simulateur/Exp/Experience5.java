...
public class Experience5 {
	...
	public static void main(String[] Args) {
		...
		PlanCircuit.addAll(AR("Sortie", 0, 3,
				L(E(L(N(L("a")), N(L("b")))), E(L(N(L("a")), L("b"))), E(L(L("a"), N(L("b")))), E(L(L("a"), L("b"))))));
		...
		S.add(DS);
		simulateur.erwan.Module M = new simulateur.erwan.Module(PlanCircuit, E, S, null);
